...
- Undo history is _nonlinear_, which means if you undo and do something other than redo, the redos aren't discarded. Instead, a new branch is created in the _history tree_. Jump to any point in history with **Edit > History** or <kbd>Ctrl+Shift+Y</kbd>
...
- Edit transparent images! To create a transparent image,
  ...
  Images with _any_ translucent pixels will open in Transparent mode.
...
- When you do **Edit > Paste From...** you can select transparent images.
  ...
  smear it across the canvas _while it animates_!~~
...
- There's a black and white mode with _patterns_ instead of colors in the palette,
...
- In addition to the left-click foreground color and the right-click background color,
  ...
  press and release <kbd>Ctrl</kbd> to switch colors _while drawing_.
